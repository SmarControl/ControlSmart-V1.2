    ...
    public static partial class Texts
    {
        ...
        public static class Forms
        {
            public static class Membership
            {
                ...
                {
                    public static LocalText EmailSubject = "Reset Your ControlSmart Password";
                ...
                {
                    public static LocalText ActivateEmailSubject = "Activate Your ControlSmart Account";
        ...
        public static class Navigation
        {
            ...
            public static LocalText SiteTitle = "ControlSmart";
        }
